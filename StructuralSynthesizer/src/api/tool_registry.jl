...
const TOOL_REGISTRY = [
    ...
    Dict{String, Any}(
        ...
        "description"       => "Past designs in this session (params patch, pass/fail, critical ratio, EC).",
        "phase"             => "orientation",
        "use_when"          => "Checking what has already been tried, or the user asks about previous runs.",
        "args"              => Dict{String, Any}(),
        "returns"           => "Array of design snapshots with index, timestamp, params, pass/fail, EC.",
        "requires_design"   => false,
        "requires_geometry" => false,
    ),
    Dict{String, Any}(
    ...
    Dict{String, Any}(
        ...
        "description"       => "Delta table between two designs from session history.",
        "phase"             => "exploration",
        "use_when"          => "After run_design, to show what changed. Or the user asks to compare two runs.",
        "args"              => Dict{String, Any}(
        ...
        "returns"           => "Dict with deltas: pass/fail, critical ratio, EC, params that differ.",
        "requires_design"   => true,
        "requires_geometry" => false,
    ),
    Dict{String, Any}(
