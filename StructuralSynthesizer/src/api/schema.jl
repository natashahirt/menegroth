    ...
    return Dict(
        ...
        "params" => Dict(
            ...
            "fields" => Dict(
                ...
                "column_sizing_strategy" => "discrete (catalog / MIP) or nlp (continuous Ipopt). Default: discrete. Applies to RC and steel columns.",
                ...
                "beam_sizing_strategy" => "discrete (catalog / MIP) or nlp (continuous Ipopt). Default: discrete. Applies to RC and steel beams.",
