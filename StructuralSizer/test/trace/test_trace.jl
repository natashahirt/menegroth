...
@testset "build_stage_timeline" begin
    ...
    @test isempty(build_stage_timeline(events_unmatched))
end
...
@testset "filter_trace" begin
    ...
    # Decisions: includes iteration/decision too
    ...
    @test isempty(filter_trace(events; tier=:full, element="nonexistent"))
