...
@testset "RC Column NLP Optimization" begin
    ...
    @testset "Basic NLP solve - ipopt" begin
        ...
        result = size_column_nlp(300.0kip, 100.0kip*u"ft", geometry, opts)
    ...
    @testset "NLP solve with Ipopt" begin
        ...
        result = size_column_nlp(500.0kip, 200.0kip*u"ft", geometry, opts)
    ...
    @testset "Multiple columns" begin
        ...
        results = size_columns_nlp(Pu, Mux, geoms, opts)
    ...
    @testset "Slenderness effects" begin
        ...
        result_with = size_column_nlp(400.0kip, 100.0kip*u"ft", geometry, opts_with)
        result_without = size_column_nlp(400.0kip, 100.0kip*u"ft", geometry, opts_without)
    ...
    @testset "Prefer square option" begin
        ...
        result = size_column_nlp(400.0kip, 200.0kip*u"ft", geometry, opts_square)
